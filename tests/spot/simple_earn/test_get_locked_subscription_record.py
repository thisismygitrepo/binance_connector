...
def test_get_locked_subscription_record():
    """Tests the API endpoint to get locked subscription record"""

    client = Client(key, secret)
    response = client.get_locked_subscription_record(**send_params)
