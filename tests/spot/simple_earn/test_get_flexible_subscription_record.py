...
def test_get_flexible_subscription_record():
    """Tests the API endpoint to get flexible subscription record"""

    client = Client(key, secret)
    response = client.get_flexible_subscription_record(**send_params)
